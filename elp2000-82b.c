...
{
    // array holding Delaunay arguments
    double delaunay_arguments[TOTAL_DELAUNAY_ARGUMENTS];
    // array holding ELP2000 arguments
    double elp2000_arguments[TOTAL_ELP2000_ARGUMENTS];
    // array holdng planetary arguments
    double planetary_arguments[TOTAL_PLANETARY_ARGUMENTS];
    // argument that includes precession (ζ)
    double zeta;
    ...
    sp.longitude = compute_serie_a_sin(delaunay_arguments,
                                       main_problem_longitude_multipliers,
                                       main_problem_longitude_coefficients,
                                       TOTAL_MAIN_PROBLEM_LONGITUDE_TERMS);
    sp.latitude = compute_serie_a_sin(delaunay_arguments,
                                      main_problem_latitude_multipliers,
                                      main_problem_latitude_coefficients,
                                      TOTAL_MAIN_PROBLEM_LATITUDE_TERMS);
    sp.distance = compute_serie_a_cos(delaunay_arguments,
    ...
    sp.longitude += compute_serie_b(zeta, delaunay_arguments,
                                    ...
                                    earth_figure_longitude_0_coefficients,
                                    TOTAL_EARTH_FIGURE_LONGITUDE_0_TERMS);
    sp.latitude += compute_serie_b(zeta, delaunay_arguments,
                                   earth_figure_latitude_0_multipliers,
                                   earth_figure_latitude_0_coefficients,
                                   TOTAL_EARTH_FIGURE_LATITUDE_0_TERMS);
    sp.distance += compute_serie_b(zeta, delaunay_arguments,
    ...
    sp.longitude += compute_serie_b(zeta, delaunay_arguments,
                                    earth_figure_longitude_0_multipliers,
                                    earth_figure_longitude_0_coefficients,
                                    TOTAL_EARTH_FIGURE_LONGITUDE_0_TERMS) * t;
    sp.latitude += compute_serie_b(zeta, delaunay_arguments,
                                   earth_figure_latitude_0_multipliers,
                                   earth_figure_latitude_0_coefficients,
                                   TOTAL_EARTH_FIGURE_LATITUDE_0_TERMS) * t;
    sp.distance += compute_serie_b(zeta, delaunay_arguments,
                                   earth_figure_distance_0_multipliers,
                                   earth_figure_distance_0_coefficients,
    ...
    sp.longitude += compute_serie_c(planetary_arguments, delaunay_arguments,
                                    ...
                                    planetary1_longitude_0_coefficients,
                                    TOTAL_PLANETARY1_LONGITUDE_0_TERMS);
    sp.latitude += compute_serie_c(planetary_arguments, delaunay_arguments,
                                   planetary1_latitude_0_multipliers,
                                   planetary1_latitude_0_coefficients,
                                    TOTAL_PLANETARY1_LATITUDE_0_TERMS);
    sp.distance += compute_serie_c(planetary_arguments, delaunay_arguments,
    ...
    sp.longitude += compute_serie_c(planetary_arguments, delaunay_arguments,
                                    ...
                                    planetary1_longitude_1_coefficients,
                                    TOTAL_PLANETARY1_LONGITUDE_1_TERMS) * t;
    sp.latitude += compute_serie_c(planetary_arguments, delaunay_arguments,
                                   planetary1_latitude_1_multipliers,
                                   planetary1_latitude_1_coefficients,
                                   TOTAL_PLANETARY1_LATITUDE_1_TERMS) * t;
    sp.distance += compute_serie_c(planetary_arguments, delaunay_arguments,
    ...
    sp.longitude += compute_serie_d(planetary_arguments, delaunay_arguments,
                                    ...
                                    planetary2_longitude_0_coefficients,
                                    TOTAL_PLANETARY2_LONGITUDE_0_TERMS);
    sp.latitude += compute_serie_d(planetary_arguments, delaunay_arguments,
                                   planetary2_latitude_0_multipliers,
                                   planetary2_latitude_0_coefficients,
                                   TOTAL_PLANETARY2_LATITUDE_0_TERMS);
    sp.distance += compute_serie_d(planetary_arguments, delaunay_arguments,
    ...
    sp.longitude += compute_serie_d(planetary_arguments, delaunay_arguments,
                           ...
                           planetary2_longitude_1_coefficients,
                           TOTAL_PLANETARY2_LONGITUDE_1_TERMS) * t;
    sp.latitude += compute_serie_d(planetary_arguments, delaunay_arguments,
                           planetary2_latitude_1_multipliers,
                           planetary2_latitude_1_coefficients,
                           TOTAL_PLANETARY2_LATITUDE_1_TERMS) * t;
    sp.distance += compute_serie_d(planetary_arguments, delaunay_arguments,
    ...
    sp.longitude += compute_serie_b(zeta, delaunay_arguments,
                           ...
                           tidal_longitude_0_coefficients,
                           TOTAL_TIDAL_LONGITUDE_0_TERMS);
    sp.latitude += compute_serie_b(zeta, delaunay_arguments,
                           tidal_latitude_0_multipliers,
                           tidal_latitude_0_coefficients,
                           TOTAL_TIDAL_LATITUDE_0_TERMS);
    sp.distance += compute_serie_b(zeta, delaunay_arguments,
    ...
    sp.longitude += compute_serie_b(zeta, delaunay_arguments,
                           ...
                           tidal_longitude_1_coefficients,
                           TOTAL_TIDAL_LONGITUDE_1_TERMS) * t;
    sp.latitude += compute_serie_b(zeta, delaunay_arguments,
                           tidal_latitude_1_multipliers,
                           tidal_latitude_1_coefficients,
                           TOTAL_TIDAL_LATITUDE_1_TERMS) * t;
    sp.distance += compute_serie_b(zeta, delaunay_arguments,
    ...
    sp.longitude += compute_serie_b(zeta, delaunay_arguments,
                           ...
                           moon_figure_longitude_coefficients,
                           TOTAL_MOON_FIGURE_LONGITUDE_TERMS);
    sp.latitude += compute_serie_b(zeta, delaunay_arguments,
                           moon_figure_latitude_multipliers,
                           moon_figure_latitude_coefficients,
                           TOTAL_MOON_FIGURE_LATITUDE_TERMS);
    sp.distance += compute_serie_b(zeta, delaunay_arguments,
    ...
    sp.longitude += compute_serie_b(zeta, delaunay_arguments,
                           ...
                           relativistic_longitude_coefficients,
                           TOTAL_RELATIVISTIC_LONGITUDE_TERMS);
    sp.latitude += compute_serie_b(zeta, delaunay_arguments,
                           relativistic_latitude_multipliers,
                           relativistic_latitude_coefficients,
                           TOTAL_RELATIVISTIC_LATITUDE_TERMS);
    sp.distance += compute_serie_b(zeta, delaunay_arguments,
    ...
    sp.longitude += compute_serie_b(zeta, delaunay_arguments,
                           ...
                           TOTAL_PLANETARY_LONGITUDE_2_TERMS) * t * t;
    sp.latitude += compute_serie_b(zeta, delaunay_arguments,
                           planetary_latitude_2_multipliers,
                           planetary_latitude_2_coefficients,
                           TOTAL_PLANETARY_LATITUDE_2_TERMS) * t * t;
    sp.distance += compute_serie_b(zeta, delaunay_arguments,
...
{
    sphpoint sp;    // a value in spherical coordinates
    recpoint rp;    // resulting value in rectangular coordiantes
                    // (reference frame of ELP2000)

    // computing Moon's position in spherical coordinates
    sp = geocentric_moon_position(t);
    
    // converting to rectangular coordinates
    rp.x = sp.distance * cos(radian(sp.longitude / ARCSECONDS_IN_DEGREE)) *
           cos(radian(sp.latitude / ARCSECONDS_IN_DEGREE));
    rp.y = sp.distance * sin(radian(sp.longitude / ARCSECONDS_IN_DEGREE)) *
           cos(radian(sp.latitude / ARCSECONDS_IN_DEGREE));
...
{
    recpoint rp;        // position of the Moon in rectangular coordinates
                        // referred to the ELP2000 reference frame
    recpoint re2000p;   // position of the Moon in rectangular coordinates
                        // referred to the internal mean ecliptic and
                        // equinox of J2000
    
    double p, q;        // intermediate auxiliary convertion variables
                        // from Laskar's series
    
    // computing Moon's position in rectangular coordinates referred to
    // the ELP2000 reference frame
    rp = geocentric_moon_position_rect(t);
    ...
    // performing rotation of ELP2000 reference frame into mean dynamical
    // ecliptic and equinox of J2000
    re2000p.x = (1 - 2 * p * p)                  * rp.x +
                2 * p * q                        * rp.y +
                2 * p * sqrt(1 - p * p - q * q)  * rp.z;
    re2000p.y = 2 * p * q                        * rp.x +
                (1 - 2 * q * q)                  * rp.y -
                2 * q * sqrt(1 - p * p - q * q)  * rp.z;
    re2000p.z = -2 * p * sqrt(1 - p * p - q * q) * rp.x +
                2 * q * sqrt(1 - p * p - q * q)  * rp.y +
                (1 - 2 * p * p - 2 * q * q)      * rp.z;
...
{
    recpoint re2000p;   // position of the Moon in rectangular coordianted
                        // referred to the internal mean ecliptic and
                        // equinox of J2000
    recpoint rfk5p;     // position of the Moon in rectangular coordinates
                        // referred to the FK5 equator γFK5 (mean equator
                        // and rotational mean equinox of J2000)
    
    // computing Moon's position in rectangular coordinates referred to the
    // internal mean ecliptic and equinox of J2000
    re2000p = geocentric_moon_position_of_J2000(t);
    
    // performing transformation to rectangular coordinates referred to
    // the FK5 equator
